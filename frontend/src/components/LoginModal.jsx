      ...
      {open && (
        ...
        >
          <motion.div
            ...
            className="relative w-full max-w-md p-1px rounded-3xl bg-linear-to-br
             from-purple-500/40 via-blue-500/30 to-transparent"
            onClick={(e) => e.stopPropagation()}
          >
            <div
              className="relative rounded-3xl bg-[#0b0b0b] border border-white/10 shadow-[0_30px_120px_rgba(0,0,0,0.8)]
                 overflow-hidden "
            >
              <motion.div
              ...
              <div className="relative px-8 pt-14 pb-10 text-center">
                ...
                >
                    ...
                    <img
                    src="https://imgs.search.brave.com/kj-UvQkAOXua2idi32Sh6y6wgc1npdY0blMVVORMDIw/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9jZG4u/aWNvbnNjb3V0LmNv/bS9pY29uL3ByZW1p/dW0vcG5nLTI1Ni10/aHVtYi9nb29nbGUt/aWNvbi1zdmctZG93/bmxvYWQtcG5nLTc2/ODM0NDEucG5nP2Y9/d2VicCZ3PTEyOA"
