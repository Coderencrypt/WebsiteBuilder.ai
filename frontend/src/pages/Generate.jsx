...
function Generate() {
    ...
    const handleGenerateWebsite = async () => {
        ...
        try {
            ...
            // Short delay so the user can see the 100% completion animation before redirecting
            setTimeout(() => {
                setLoading(false)
    ...
    useEffect(() => {
        ...
        const interval = setInterval(() => {
            // Fixed Math.random() function calls
        ...
        <div className='min-h-screen bg-linear-to-br from-[#050505] via-[#0b0b0b] to-[#050505] text-white'>
            ...
            <div className='max-w-6xl mx-auto px-6 py-16'>
                ...
                <div className='mb-14'>
                    ...
                    <div className='relative'>
                        <textarea 
                            ...
                            className='w-full h-56 p-6 rounded-3xl bg-black/60 border-white/10 
                ...
                <div className='flex justify-center'>
                    <motion.button
                        whileHover={prompt.trim() && !loading ? { scale: 1.05 } : {}}
                        whileTap={prompt.trim() && !loading ? { scale: 0.96 } : {}}
                        onClick={handleGenerateWebsite}
                        disabled={!prompt.trim() || loading} // Fixed OR logic bug
                        className={`px-14 py-4 rounded-2xl font-semibold text-lg transition-colors ${
                            prompt.trim() && !loading 
