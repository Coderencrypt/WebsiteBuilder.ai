  ...
  return (
    <div className="h-screen w-screen flex bg-black text-white overflow-hidden">
      ...
      border border-white/10 text-sm outline-none"
              ...
              />
              <button
                className="px-4 py-3 rounded-2xl bg-white text-black" disabled = {updateLoading}
        ...
        <div className="h-14 px-4 flex justify-between items-center border-b border-white/10 bg-black/80">
          ...
          <div className="flex gap-2">
            {website.deployed ?"":<button
              className="flex items-center gap-2 px-4 py-1.5 rounded-lg bg-linear-to-r from-indigo-500 to-purple-500
